...
namespace App\Http\Controllers\V1\Schools {
    class SchoolsSearchController
    {
        ...
        public static function debug()
        {
            return \App\Http\Controllers\V1\Schools\SchoolsSearchController::debug();
        }
        ...
        public static function downloadExcel($fileName, $writerType = null, $withHeadings = false, $responseHeaders = [])
        {
            return \App\Http\Controllers\V1\Schools\SchoolsSearchController::downloadExcel($fileName, $writerType, $withHeadings, $responseHeaders);
        }
        ...
        public static function storeExcel($filePath, $disk = null, $writerType = null, $withHeadings = false)
        {
            return \App\Http\Controllers\V1\Schools\SchoolsSearchController::storeExcel($filePath, $disk, $writerType, $withHeadings);
        }
        ...
        public static function ray($description = '')
        {
            return \App\Http\Controllers\V1\Schools\SchoolsSearchController::ray($description);
        }
    }
}
