...
function calculateDifferenceAfterMonthlySponsorship(): float
{
    return 0.00;
}

function calculateDifferenceBeforeMonthlySponsorship(): float
{
    return 0.00;
}

function calculateMonthlySponsorshipRate(): float
{
    return 0.00;
}

function calculateAssociationMonthlySponsorship(): float
{
    return 0.00;
}
