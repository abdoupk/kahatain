...
class ArchiveDetailsMonthlySponsorshipController extends Controller implements HasMiddleware
{
    ...
    {
        return Inertia::render('Tenant/archive/details/monthly-sponsorship/MonthlySponsorshipArchiveDetailsPage', [
