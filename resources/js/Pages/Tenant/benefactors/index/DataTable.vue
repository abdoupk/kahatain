...
defineProps<{ benefactors: PaginationData<BenefactorsIndexResource>; params: IndexParams }>()
...
<template>
    <div class="@container">
        ...
        <div class="col-span-12 my-8 grid grid-cols-12 gap-4 @3xl:hidden">
            <div v-for="benefactor in benefactors.data" :key="benefactor.id" class="intro-y col-span-12 @xl:col-span-6">
                <div class="box p-5">
                    <div class="flex">
