        ...
        <base-table class="mt-2 border-separate border-spacing-y-[10px]">
            <base-thead-table>
                <base-tr-table>
                    ...
                    <the-table-th
                        :direction="params.directions && params.directions['aggregate_white_meat_benefit']"
                        class="!w-32 text-center"
                        sortable
                        @click="emit('sort', 'aggregate_white_meat_benefit')"
                    >
                        {{ $t('aggregate_white_meat_benefit') }}
                    </the-table-th>

                    <the-table-th
                        :direction="params.directions && params.directions['aggregate_red_meat_benefit']"
                        class="!w-32 text-center"
                        sortable
                        @click="emit('sort', 'aggregate_red_meat_benefit')"
                    >
