...
import { MonthlySponsorshipStatisticsType } from '@/types/statistics'
...
defineProps<{ monthlySponsorship: MonthlySponsorshipStatisticsType }>()
</script>

<template>
    <suspense v-if="sumObjectValues(Object.values(monthlySponsorship))" suspensible>
        <base-line-chart
            :datasets="[
                {
                    data: Object.values(monthlySponsorship),
