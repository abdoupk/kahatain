...
const labels = props.ramadanBasket ? Object.keys(props.ramadanBasket[Object.keys(props.ramadanBasket)[0]]) : []

const datasets = labels.length
...
<template>
    <base-vertical-bar-chart v-if="labels.length" :datasets :height="300" :labels></base-vertical-bar-chart>
