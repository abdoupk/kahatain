...
const labels = Object.keys(props.ramadanBasket[Object.keys(props.ramadanBasket)[0]])

const datasets = Object.keys(props.ramadanBasket).map((year) => {
    return {
        label: year,
...
<template>
    <base-vertical-bar-chart v-if="true" :datasets :height="300" :labels></base-vertical-bar-chart>
